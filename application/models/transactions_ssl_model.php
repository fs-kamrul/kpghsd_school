...
class transactions_ssl_model extends CI_Model {

    public function save_all_ssl_data($data) {
        $this->db->insert('transactions_ssl', $data);
        $insert_id = $this->db->insert_id();
        return  $insert_id;
    }
    public function check_customer_tran_id($id) {
        $this->db->select('*');
        $this->db->from('transactions_ssl');
