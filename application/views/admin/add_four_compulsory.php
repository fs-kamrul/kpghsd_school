                ...
                <table class="table" >
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td>
                                <select onchange="show_subject('subject_show');"  name="class" id="class_id" >
                                    <?php
                                    foreach ($option as $v_option) {
                                        $a = $v_option->opt_a;
                                        if ($a == 'class') {
                        ...
                        <tr class="">
                            ...
                            <td>
                                <select onchange="show_subject('subject_show');"  name="group_r" id="group_r" class="">
                                    <?php
                                    foreach ($option as $v_option) {
                                        $a = $v_option->opt_a;
                                        if ($a == 'group') {
                        ...
                        <tr class="">
                            ...
                            <td id="subject_name">
                                <select  name="sub_id" id="subject_show" >
