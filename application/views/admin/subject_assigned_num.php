...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>subject_panel/save_subject_assigned" method="post" class="form-horizontal">
                <table class="table" >
                    <!--<thead>
                        <tr>
                            <th>#</th>
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td></td>
                            <td>
                                <button type="submit" class="btn btn-primary"><?php echo $this->lang->line('save_subject_assigned');?></button>
                            </td>
                            <td></td>
                        </tr>
                    </tbody>
...
<div class="block">
    <div class="navbar navbar-inner block-header">
        <div class="muted pull-left">View Assign Subject</div>
    </div>
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>subject_panel/view_assign_subject.html" method="post" class="form-horizontal">
                    ...
                    foreach ($all_reg as $v_reg) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url(); ?>subject_panel/sub_ass_delete/<?php echo $v_reg->assigned_id; ?>" onclick="return check_delete();"><button class="btn btn-danger"><i class="icon-remove icon-white"></i><?php echo $this->lang->line('delete');?></button></a>
