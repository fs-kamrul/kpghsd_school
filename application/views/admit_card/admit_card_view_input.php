...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>admit_card_panel/admid_card_show" method="post" class="form-horizontal">
                <table class="table" >
                    <!--<thead>
                        <tr>
                            <th>#</th>
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td>
                                <select  name="time[]" id="select01" class="time_width" >
                                    <?php
                                    for ($i=1;$i<=12;$i++) {  ?>
                                ...
                                <select  name="time[]" id="select01" class="time_width" >
                                    <option value="<?php echo 'AM'; ?>" ><?php echo 'AM'; ?></option>
                        ...
                        <tr class="">
                            <td>Design: </td>
                            <td>
                                <input type="radio" id="design1" name="design" value="1" checked="" /> <label for="design1" style="display: inline">Design 1</label>
                                <input type="radio" id="design2" name="design" value="2" />  <label for="design2" style="display: inline">Design 2</label>
                            </td>
                            <td></td>
                        </tr>
<!--                        <tr class="">-->
<!--                            <td>Type</td>-->
<!--                            <td>-->
<!--                                <input class="radio" type="radio" name="typ" value="0" checked=""> Collage Admit Card -->
<!--                                <input class="radio" type="radio" name="typ" value="1"> School Admit Card -->
<!--                            </td>-->
<!--                            <td></td>-->
<!--                        </tr>-->
                        <tr class="">
