            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    if(count($baton_set_package)>0) {
                            ...
                            $all_baton_show_january     = $baton_set_package->development_fee + $baton_set_package->tution_fee + $baton_set_package->tiffin_fee + $baton_set_package->admission_fee + $baton_set_package->session_fee ;
                            $all_baton_show_january_fee = $baton_set_package->development_fee + $baton_set_package->tution_fee + $baton_set_package->tiffin_fee + $baton_set_package->admission_fee + $baton_set_package->session_fee + $baton_set_package->fine;
                    }else{ ?>
                        <script>
                            alert("This Class can not be set any package. Please set package First.");
                        </script>
                   <?php }
                    if(isset($all_class)){
...
//                        foreach ($all_baton as $key => $value) {
                            if(isset($all_baton[$value3->id]['mon'])){
                                 ...
                                 foreach ($all_baton[$value3->id]['mon'] as $key2 => $value2) {
                                     if ($all_baton[$value3->id]['stu_year'] == $value2['year']) {
                                         if ($value1 == $key2) {
                                             echo $value2['total'];
