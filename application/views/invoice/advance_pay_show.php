...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>invoice_panel/advance_pay_generate.html" method="post" class="form-horizontal">
...
<!--                                        <option value="--><?php //echo 'Previous Due'; ?><!--" selected>--><?php //echo 'Previous Due'; ?><!--</option>-->
                        ...
                        <td style="background-color: #00fd20;">
                            ...
                            <select  name="fees_type" id="select01" class="">
                                <option value="<?php echo 'tuition_fees'; ?>" selected><?php echo $this->lang->line('tuition_fees'); ?></option>
                                <option value="<?php echo 'admission_fees'; ?>"><?php echo $this->lang->line('admission_fees'); ?></option>
                            </select>
                        </td>
                    </tr>
                    </tbody>
