...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>invoice_panel/generate_invoice_baton" method="post" class="form-horizontal">
                <table class="table" >
                    <tbody>
                        <tr class="">
                            <td></td>
                        ...
                        <tr class="">
                            <td></td>
                            <td><?php echo $this->lang->line('baton');?> <?php echo $this->lang->line('year');?> :</td>
                            <td>
                        ...
                        <tr class="">
                            <td></td>
                            <td><?php echo $this->lang->line('baton');?> <?php echo $this->lang->line('month');?></td>
                            <td>
                                <select  name="month" id="select01" class="">
                                    <?php
                                    foreach ($month as $v_option) {?>
                                        <option value="<?php echo $v_option; ?>"  <?php echo ($sdata['month_s'] == $v_option) ? 'selected' : ''; ?> ><?php echo $v_option; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td></td>
                        ...
                        <tr class="">
                            <td></td>
                            <td><?php echo $this->lang->line('admission');?> :</td>
                            <td><input style="display: inline;" type="checkbox" name="admission" id="admission" value="1"><label style="display: inline;" for="admission"><?php echo $this->lang->line('admission');?></label>
                            </td>
                            <td></td>
                        </tr>
                        <tr class="">
