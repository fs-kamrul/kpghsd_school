...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>invoice_panel/show_invoice_set_package" method="post" class="form-horizontal">
                <table class="table" >
                    <tbody>
                        <tr class="">
                            <td></td>
...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>invoice_panel/invoice_set_package.html" method="post" class="form-horizontal">
...
//                    print_r($baton_set_package);
                    foreach ($baton_set_package as $v_reg) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>invoice_panel/invoice_set_delete/<?php echo $v_reg->id; ?>" onclick="return check_delete();"><button class="btn btn-danger"><i class="icon-remove icon-white"></i> <?php echo $this->lang->line('delete');?></button></a>
<!--                                <a href="--><?php //echo base_url(); ?><!--invoice_panel/invoice_set_edit/--><?php //echo $v_reg->id; ?><!--"><button class="btn btn-primary"><i class="icon-edit icon-white"></i> --><?php //echo $this->lang->line('edit');?><!--</button></a>-->
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
