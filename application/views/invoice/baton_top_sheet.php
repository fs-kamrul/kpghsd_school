...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>invoice_panel/top_sheet.html" method="post" class="form-horizontal">
<!--                <samp><b>View: </b></samp>
...
<!--                            <td style="text-align: center;">--><?php //echo $value->total_amnt + $value->fine - $value->total_paid; ?><!--</td>-->
                            ...
                            <td style="text-align: center;"><?php echo date("d M, Y", strtotime($value->b_invoice_date)); ?></td>
