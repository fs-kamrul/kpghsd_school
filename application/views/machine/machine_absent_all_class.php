...
<?php foreach ($stu as $value) { if($value['date'] == ''){ ?>
                        <tr>
                            ...
                            <td>
                                Dear guardian, <?php echo $value['name']; ?>, <?php echo $this->lang->line('class');?>: <?php echo $value['class']; ?> absent on <?php echo date('d-m-Y',strtotime($form_date)).' '.$academy_info->s_name; ?>.
                            </td>
                        </tr>
<?php } } ?>
                </tbody>
