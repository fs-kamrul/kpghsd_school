...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>machine_attendant_panel/absent_sms_all_class.html" method="post" class="form-horizontal">
                <table class="table" >
                    <!--<thead>
                        <tr>
                            <th>#</th>
...
//                                        echo $d;
                        ...
                        <tr class="">
                            ...
                            <td>
                                <select name="class[]" id="multiselect" multiple  data-live-search="true">
                                    <?php
                                    foreach ($option as $v_option) {
                                        $a = $v_option->opt_a;
                                        if ($a == 'class') {
