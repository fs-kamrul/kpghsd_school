...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>machine_attendant_panel/yearly_report_show.html" method="post" class="form-horizontal">
                <table class="table" >
                    <!--<thead>
                        <tr>
                            <th>#</th>
...
<!--                                    <option value=""><?php echo $this->lang->line('all_group');?></option>-->
                        ...
                        <tr class="">
                            ...
                            <td>
                                ...
                                <p>[ Note : <span style="color: #ff0000">End Date Default</span> is Start date to continue 12 Month. ]</p>
                            </td>
                            <td></td>
                        </tr>
                        <tr class="">
