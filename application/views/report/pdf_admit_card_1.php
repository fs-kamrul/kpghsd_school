...
if($io%2==0){
    $pdf->AddPage();
    $pdf->Image('images/im_pdf/bg.jpg',0,0,210,140);
    $banner=1;$signature=192;
    $pic=9;$a1=13;$a2=120;$b1=90;$c1=165;
}
    $pdf->Image('images/im_pdf/bg.jpg',0,141,210,140);
...
$pdf->SetFont('SairaExtraCondensed', '', 14);
$pdf->Cell($sit, $h, '1ST TERM EXAMINATION - 2017', 0, 1, 'C');
...
$pdf->Cell($sit, $h, '', 0, 1, 'L');
    ...
    $ex=47.5;
        ...
        $pdf->Cell($ex, $h, '01/01/2017-WEDNESDAY', 1, 0, 'r');
        $pdf->Cell($ex, $h, 'ENGLISH', 1, 0, 'r');
        $pdf->Cell($ex, $h, '01/01/2017-THURSDAY', 1, 0, 'r');
        $pdf->Cell($ex, $h, 'BANGLA', 1, 1, 'r');
