...
foreach ($main_a as $key => $value) {
    ...
    $pdf->Image('images/border_02.jpg',$bx, $by, $bz,30.2);
//    if(empty($picture_file)){
    ...
    $pdf->Image('images/bg_10.png', $bgx, $bgy, $bgz,86);
...
//    $pdf->SetFont('SairaExtraCondensed', '', 13.5);
    ...
    $pdf->Cell($hef,$th,"    School & College",'LR',1,'C');
        $pdf->SetX($x);
    ...
    $pdf->Cell($hef,$th-1.5+8,"                 ID: $value->id",'LR',1,'L');
    $pdf->SetX($x);
...
//    $pdf->SetTextColor(0,0,160);
    ...
    if ($k==1) {
        ...
        $k=0;
        $y=$y+92;$x = 13.5;
        $px=14;$py+=92;$sy+=92;$sx=27.6;$lx=46;$ly+=92;$bx=25;$rx=52;$by+=92;$ry+=92;
        $bgx=13.5;$bgy=$y;
    }
}
$pdf->Output();
