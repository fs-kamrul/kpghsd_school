    ...
    <div class="block-content collapse in" id="printdiv">
        ...
        <div class="span12">
            <table class="table box-table-a">
                <thead>
                    <tr>
                        <th style="text-align: center;"><?php echo $this->lang->line('image');?></th>
                        ...
                        <th style="text-align: center;"><?php echo $this->lang->line('birth_date');?></th>
                        <th style="text-align: center;"><?php echo $this->lang->line('student_name');?><br><?php echo $this->lang->line('father_name');?><br><?php echo $this->lang->line('mother_name');?></th>
                        <th style="text-align: center;"><?php echo $this->lang->line('student_number');?></th>
<!--                        <th style="text-align: center;"><?php echo $this->lang->line('father_name');?></th>-->
<!--                        <th style="text-align: center;"><?php echo $this->lang->line('mother_name');?></th>-->
                    ...
                    if(isset($all_b)){
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <img height="100" width="120" src="<?php if($value->photo!=""){ echo base_url() . $value->photo; } ?>" alt="<?php echo $value->name; ?>">
                            </td>
                            ...
                            <td style="text-align: center;"><?php if($value->birth_bate=='0000-00-00'){}else{ echo date("d-m-Y", strtotime($value->birth_bate)); } ?></td>
                            <td style="text-align: center;"><?php echo $value->name."<br>".$value->father_name."<br>".$value->mother_name; ?></td>
                            <td style="text-align: center;"><?php echo $value->stu_phone; ?></td>
<!--                            <td style="text-align: center;">--><?php //echo $value->father_name; ?><!--</td>-->
<!--                            <td style="text-align: center;">--><?php //echo $value->mother_name; ?><!--</td>-->
                            <td style="text-align: center;"><?php echo $value->mobile_number; ?></td>
                            <td style="text-align: center;"><?php echo $value->village.", ".$value->post.", ".$value->sub_district.", ".$value->district; ?></td>
