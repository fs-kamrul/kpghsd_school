...
<div class="block">
    ...
    <div class="block-content collapse in" id="printdiv">
        ...
        <div class="span12">
            <table class="table box-table-a" id="table">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Stu Phone</th>
                ...
                <tbody>
                    ...
                    if(isset($all_b)){
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo $this->sp_model->select_tag($value->reg_id); ?></td>
...
$("#table").table2excel({
    ...
    name: "Worksheet Name",
    filename: "Cpscn_id_card_number.xls",
    fileext: ".xls"
});
</script>
