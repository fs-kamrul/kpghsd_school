...
<script type="text/javascript">
    $(document).ready(function() {
        $('#select_all').on('click', function() {
            if (this.checked) {
                $("#term_prev").attr("disabled", false);
            } else {
                $("#term_prev").attr("disabled", true);
            }
        });
    });
</script>
...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>pdf_panel/result_show" method="post" class="form-horizontal">
                <table class="table" >
                    <!--<thead>
                        <tr>
                            <th>#</th>
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            <td></td>
                            <td><?php echo $this->lang->line('previous_mark_show');?>:<input type="checkbox" name="term_show" id="select_all" class="uniform_on"></td>
                            <td>
                                <select  name="term_prev" id="term_prev" class=""  disabled="">
                                    <?php
                                    foreach ($option as $v_option) {
                                        $a = $v_option->opt_a;
                                        if ($a == 'term') {
