...
<div class="block">
    ...
    <div class="block-content collapse in">
        <div class="span12">
            <form action="<?php echo base_url(); ?>pdf_panel/admid_card_show" method="post" class="form-horizontal">
                <table class="table" >
                    <!--<thead>
                        <tr>
                            <th>#</th>
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            <td>Design: </td>
                            <td>
                                <input type="radio" name="design" value="1" checked="" /> Design 1
                                <input type="radio" name="design" value="2" /> Design 2
                            </td>
                            <td></td>
                        </tr>
                        <tr class="">
