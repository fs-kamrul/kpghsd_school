...
//    $pdf->Cell(115, $h-1, '', 0, 0, 'L');
    ...
    $pdf->Cell(29, $th, $term_prev, 1, 0, 'C');
    $pdf->Cell(30, $th, 'Mark', 1, 0, 'C');
    $pdf->Cell(20, $th, 'Total(100)', 1, 0, 'C');
    $pdf->Cell(26, $th, 'Highest Mark', 1, 0, 'C');
    $pdf->Cell(17, $th, 'Grade ', 1, 0, 'C');
    $pdf->Cell(22, $th, 'GPA Point', 1, 0, 'C');
...
//        }
    ...
    $i = $grade->num_j($j / 2);
    $j = 0;$sum2=0;    //$grade->cut_plus($sum_t);
