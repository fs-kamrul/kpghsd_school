...
//    $pdf->Image(base_url() . 'images/im_pdf/border2.jpg', 1, 1, 298);
    $pdf->Image(base_url() . 'images/im_pdf/logo.jpg', 130, 37, 35);
...
//            exit();
    ...
    $pdf->Image(base_url() . 'images/_.PNG', 227, 96 + $the + 11.5, 60);
    $pdf->Image(base_url() . 'images/iii.png', 256.5, 112, 1, $the-3);
    $pdf->Image(base_url() . 'images/iii.png', 286.5, 112, 1, $the-3);
