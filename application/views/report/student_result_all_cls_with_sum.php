...
<!--		<input type="radio" name="ak" value="sum_mark">Sum Mark
		<input type="radio" name="ak" value="with_out_sum_mark">Without Sum Mark-->
                                ...
                                foreach ($main_data as $key => $value) {
                                    ...
                                    <tr>
                                        <td><?php echo $value['id']; ?>
                                            <input type="hidden" name="all_reg_id<?php echo $count_to; ?>" value="<?php echo $value['all_reg_id']; ?>">
                                        </td>
                                        <td><?php echo $value['roll']; ?></td>
                                        <td><?php echo $value['section']; ?>
                                            <input type="hidden" name="section<?php echo $count_to; ?>" value="<?php echo $value['section']; ?>">
                                        </td>
                                        <td><?php echo $value['name']; ?></td>

                                        <?php $sum_t = ""; foreach ($sub_info as $key1 => $value1) { ?>
                                            <?php
...
//                                                    echo $sum_t;
                                        ...
                                        ?><input type="hidden" name="gpa<?php echo $count_to; ?>" value="<?php echo $all_process[$value['id']]['gpa']; ?>"><?php
                                echo '</td>';
                                ...
                                ?><input type="hidden" name="position<?php echo $count_to; ?>" value="<?php echo $all_process[$value['id']]['position']; ?>"><?php
                    echo '</td>';
                    $vn1 = 0;
                    $count_to++;
                    ?>
