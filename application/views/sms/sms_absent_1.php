...
//        $stu["$value->id"]["class"] = $value->class;
...
<?php foreach ($months as $value) { ?>
                        <tr>
                            ...
                            <td>88<?php echo $value->mobile_number; ?></td>
                            <td>
                                Dear guardian, <?php echo $value->name; ?>, <?php echo $this->lang->line('class');?>: <?php echo $value->class; ?>, ID: <?php echo $value->id; ?> absent on <?php echo $day . " " . $month . " " . $year . ' ' . $academy_info->s_name; ?>
                            </td>
                        </tr>
<?php } ?>
                </tbody>
...
///$("#table").table2excel({
    ///exclude: ".excludeThisClass",
    ///name: "Worksheet Name",
    ///filename: "Cpscn_Attendant_Absent.xls",
    ///fileext: ".xls"
});
</script>