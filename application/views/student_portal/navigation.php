...
<nav class="pc-sidebar ">
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="<?php echo base_url(); ?>student_portal/dashboard" class="b-brand">
                <!-- ========   change your logo hear   ============ -->
                <img src="<?php echo kamrul_site_info('logo'); ?>" alt="" class="logo logo-lg">
                <img src=""<?php echo kamrul_site_info('logo'); ?>" alt="" class="logo logo-sm">
            </a>
        </div>
...
<!--                </li>-->
                ...
                <li class="pc-item">
                    <a href="<?php echo base_url(); ?>student_portal/dashboard" class="pc-link "><span class="pc-micon"><i class="material-icons-two-tone">home</i></span><span class="pc-mtext">Dashboard</span></a>
                </li>
                <li class="pc-item pc-caption">
                    <label>Result</label>
<!--                    <span>UI Components</span>-->
                ...
                <li class="pc-item">
                    <a href="<?php echo base_url(); ?>student_portal/result" class="pc-link "><span class="pc-micon"><i class="material-icons-two-tone">history_edu</i></span><span class="pc-mtext">Result</span></a>
                </li>
